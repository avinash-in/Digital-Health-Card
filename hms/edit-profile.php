...
<html lang="en">
	...
	<body>
		<div id="app">		
			<div class="app-content" style="padding-top: 20px;padding-left:100px;padding-bottom:60px;">
				
						<?php include('include/header.php');?>
						
				<!-- end: TOP NAVBAR -->
				<div class="main-content" style="width:600px; height:750px; border-radius:20px; border:none; box-shadow:blue 0 10px 20px" >
...
<?php if($msg) { echo htmlentities($msg);}?> </h5>
									<div class="row margin-top-30" style=" border:hidden; margin-right:none">
