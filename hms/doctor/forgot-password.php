...
<html lang="en">
	...
	<body class="login" style="padding-top:70px">
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				<div class="logo margin-top-30">
				<a href="../../index.html"><h2>Password Recovery</h2></a>
				</div>

				<div class="box-login" style="box-shadow:black 0 10px 20px; border-radius:10px" class="box-login">
